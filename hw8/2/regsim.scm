      ...
      (let ((the-ops
        ...
        (define (dispatch message)
          (cond ((eq? message 'start)
                ...
                ((eq? message 'add-bp)
                 (lambda (label pos)
                   (set! bps (cons (new-bps label pos labels) bps))))
                ...
                ((eq? message 'remove-bp)
                 (lambda (label pos)
                   (let ((breakpoints (new-bps label pos labels)))
...
(define (new-bps label pos labels)	
...
(define (remove-val val lst) (filter lst (lambda (vals) (not (eq? vals val)))))
